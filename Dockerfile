...
ENV SONAR_VERSION=7.4 \
    ...
    SQ_GIT_VERSION=1.6.1.1432   \
    SQ_SVN_VERSION=1.9.0.1370 \
    SQ_JAVA_VERSION=5.10.0.16607 \
    SQ_JS_VERSION=5.1.0.7059 \
    SQ_TS_VERSION=1.9.0.3474 \
    SQ_PHP_VERSION=2.16.0.4180 \
    SQ_PY_VERSION=1.11.0.2422 \
    SQ_CSHARP_VERSION=7.10.0.7588 \
    SQ_XML_VERSION=2.0.0.1980 \
    SQ_LDAP_VERSION=2.2.0.698 \
    SQ_GITHUB_VERSION=1.5.0.1464 \
    SQ_GO_VERSION=1.2.0.1788 \
